...
const PHRASE = 'Defence Infra Property · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>Defence Infra Property</span><span>REALTY</span></div>
