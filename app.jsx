        ...
        <div className="hero-bottom hero-fade-late" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(255,255,255,0.18)", paddingTop: 22, gap: 20, flexWrap: "wrap" }}>
          <div>
            ...
            <div className="clash" style={{ fontSize: 16, letterSpacing: "-0.02em", color: "#ffffff", fontWeight: 500 }}>
              Commercial Hub, Airport Road, Chandigarh, Punjab
            </div>
          </div>
    ...
    <section id="practice" className="manifesto">
      <div className="container">
        ...
        <div className="manifesto-credit">
          <span className="manifesto-sig">— Defence Infra Property</span>
        ...
        <div className="principal-grid">
          <div>
            <div className="principal-frame">
              <img src="assets/sachdeva-about.jpg" alt="Defence Infra Property office interior" />
            </div>
          ...
          <div className="principal-right">
            ...
            <h2 className="principal-name">Defence Infra Property</h2>
...
function Reviews() {
  const all = [
    { name: "Aman Khurana",    initial: "A", stars: 5, time: "2 months ago", text: "Defence Infra Property closed our SCO purchase end-to-end. From paperwork to registry, every detail was handled with extraordinary discretion. The most professional agency in the region." },
    ...
    { name: "Sunita Puri",      initial: "S", stars: 5, time: "1 month ago", text: "Three transactions with Defence Infra Property now. Their word is genuinely their bond. Wouldn't dream of going elsewhere." },
      ...
      <div className="container" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 56, alignItems: "flex-start" }}>
        <div className="about-photo-col" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 360, width: "100%", justifySelf: "start" }}>
          ...
          <div style={{ border: "1px solid var(--line)", borderRadius: 6, padding: "20px 22px", background: "var(--paper)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14 }}>
            <div>
              <div className="clash" style={{ fontSize: 19, letterSpacing: "-0.02em", fontWeight: 600, lineHeight: 1.1 }}>Defence Infra Property</div>
          ...
          <a
            href="https://www.google.com/maps/search/?api=1&query=Defence+Infra+Property+Commercial+Hub%2C+Airport+Road%2C+Chandigarh%2C+Punjab"
            target="_blank" rel="noopener noreferrer"
            onClick={(e) => { e.preventDefault(); window.open("https://www.google.com/maps/search/?api=1&query=Defence+Infra+Property+Commercial+Hub%2C+Airport+Road%2C+Chandigarh%2C+Punjab", "_blank", "noopener,noreferrer"); }}
            className="gs-wrap"
          ...
          >
            ...
            <div style={{ position: "absolute", left: 16, right: 16, bottom: 14, color: "#f6f6f6", display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 12 }}>
              <div>
                ...
                <div className="clash" style={{ fontSize: 15, letterSpacing: "-0.02em", marginTop: 4, fontWeight: 600 }}>Commercial Hub, Airport Road, Chandigarh, Punjab</div>
              </div>
        ...
        <div>
          ...
          <p className="clash" style={{ fontSize: "clamp(24px, 3.6vw, 48px)", letterSpacing: "-0.035em", lineHeight: 1.15, margin: 0, fontWeight: 500 }}>
            Defence Infra Property is a <span className="serif-it">GMADA</span> empanelled and <span className="serif-it">RERA</span> registered firm specializing in residential, commercial and land mandates across the Mohali tri-city. Operating from Commercial Hub, Airport Road, Chandigarh, Punjab.
          </p>
        ...
        <div className="desk-grid">
          ...
          <div className="desk-card">
            ...
            <div className="desk-row">
              ...
              <div className="desk-row-v"><a href="mailto:info@defenceinfraproperty.com">info@defenceinfraproperty.com</a></div>
            </div>
            <div className="desk-row">
              <div className="desk-row-k">In person</div>
              <div className="desk-row-v">Commercial Hub, Airport Road, Chandigarh, Punjab</div>
            </div>
...
function FooterMast() {
  return (
    <footer className="foot">
      <div className="container">
        <h2 className="foot-mast">Defence Infra Property</h2>
        <div className="foot-cols">
          <div>
            <div className="foot-h">The Desk</div>
            <ul className="foot-list">
              <li><a href="tel:+910000000000">+91-00000-00000</a></li>
              <li><a href="mailto:info@defenceinfraproperty.com">info@defenceinfraproperty.com</a></li>
              <li><span>Commercial Hub, Airport Road, Chandigarh, Punjab</span></li>
              </ul>
          </div>
          <div>
        ...
        <div className="foot-bottom">
          <div className="foot-mark">
            <Crown />
            <span>© 2026 Defence Infra Property · All rights reserved</span>
          </div>
      ...
      <div className="container">
        <div style={{ borderTop: "1px solid var(--ink-2)", paddingTop: 48, display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 32, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "flex-end" }}>
            ...
            <a href="mailto:info@defenceinfraproperty.com" className="uc" style={{ fontSize: 11, letterSpacing: "0.16em", marginTop: 8, borderBottom: "1px solid var(--ink)", paddingBottom: 4 }}>
              info@defenceinfraproperty.com
            </a>
          </div>
        </div>
      </div>
    ...
    <footer style={{ background: "var(--dark)", color: "rgba(246,246,246,0.6)", borderTop: "1px solid rgba(255,255,255,0.05)", marginTop: 40 }}>
      <div className="container" style={{ paddingTop: 72, paddingBottom: 40 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 56 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              <Crown dark />
              <div className="clash" style={{ color: "#f6f6f6", fontSize: 20, letterSpacing: "-0.03em" }}>Defence Infra Property</div>
            </div>
            <p style={{ marginTop: 20, fontSize: 14, lineHeight: 1.65, maxWidth: 300 }}>
              Real estate agency & property experts in the Mohali tri-city. GMADA/RERA accredited. Commercial Hub, Airport Road, Chandigarh, Punjab.
            </p>
          </div>
          ...
          <FooterCol head="Contact" links={[
            ...
            [<span><IconMail/> info@defenceinfraproperty.com</span>, "mailto:info@defenceinfraproperty.com"],
            [<span><IconPin/> Commercial Hub, Airport Road, Chandigarh, Punjab</span>, "#"],
            [<span><IconInsta/> @defence-infra-property</span>, "#"],
            [<span><IconYouTube/> @defence-infra-property</span>, "#"],
          ]} />
        </div>
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          <div className="uc" style={{ fontSize: 10, letterSpacing: "0.18em" }}>© 2026 Defence Infra Property — All rights reserved</div>
...
function WhatsAppFab() {
  ...
  const text = encodeURIComponent("Hello Defence Infra Property — I would like to enquire about a property listing.");
  return (
    <a
